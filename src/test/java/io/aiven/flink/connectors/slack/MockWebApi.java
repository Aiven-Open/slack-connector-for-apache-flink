...
import static io.aiven.flink.connectors.slack.MockWebSocketServer.WEB_SOCKET_SERVER_PORT;
...
public class MockWebApi extends HttpServlet {
  private static final Logger LOG = LoggerFactory.getLogger(MockWebApi.class);
